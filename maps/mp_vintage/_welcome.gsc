...
onPlayerSpawned()
{
	for( ;; )
	{
		...
		self thread welc_issue( "Welcome to Vintage map", "Map made by Angry Worm & eL tiGre", "Enjoy your stay !" );
	}
}

welc_issue( welc1, welc2, welc3 )
{
	...
	notifyData.glowColor = (0.5, 0.0, 0.2);
	notifyData.duration = level.welcomeduration;
